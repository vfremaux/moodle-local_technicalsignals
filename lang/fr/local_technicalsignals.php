...
$string['undefinedmainhost'] = 'Aucun hote principal ne répond au préfixe : {$a}. Vérifiez que la valeur de préfixe commence par http:// (ou https://). Elle peut être définie par le bloc Publication de cours, ou directement dans le fichier de configuration par défaut.';
$string['red'] = 'Rouge';
